...
var Facebook_correctLogin	= function () {
	...
	FB.api('/me', function(response) {
		...
		if (document.getElementById('fbStatus')){
                       document.getElementById('fbStatus').innerHTML = public_profile + facebookUser.name + facebookUser.first_name + facebookUser.last_name + '<br/>' + '<span>' + facebookUser.gender + ' | '+ '</span>';
